  ...
  return (
    <section className="relative w-full min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 text-center max-w-[600px] w-full px-8">
        ...
        <h1 className="text-[clamp(3rem,12vw,6rem)] font-extrabold bg-gradient-to-r from-[#a855f7] to-[#ec4899] bg-clip-text text-transparent leading-none mb-4">
          Coming Soon
        </h1>
        ...
        <p className="max-w-[420px] mx-auto text-center leading-relaxed text-white/80 mb-8 text-base md:text-lg">
          We&apos;re crafting insightful articles about cybersecurity, threat intelligence, and digital protection. Stay tuned for expert insights.
        </p>
